...
pca = PCA(n_components=X_train_pca.shape[1], random_state=seed)
pca.fit(X_train_pca)
...
# selection based on the components identified with PCA. In this case we use SciKit-Learn's Pipeline
